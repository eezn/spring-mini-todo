package eezn.todolist.minitodo.domain.todolist.options.repository.jdbctemplate;

import eezn.todolist.minitodo.domain.todolist.options.data.Status;
import eezn.todolist.minitodo.domain.todolist.options.repository.StatusRepository;
